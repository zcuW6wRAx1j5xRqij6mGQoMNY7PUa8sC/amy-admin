...
import { CryptoDelFutures, CryptoFuturesList } from '@/service/api/crypto';
...
<template>
  <div class="min-h-500px flex-col-stretch gap-16px overflow-hidden lt-sm:overflow-auto">
    ...
    <NCard title="合约管理" :bordered="false" size="small" class="card-wrapper sm:flex-1-hidden">
