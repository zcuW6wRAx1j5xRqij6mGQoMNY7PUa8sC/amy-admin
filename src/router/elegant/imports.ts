...
export const views: Record<LastLevelRouteKey, RouteComponent | (() => Promise<RouteComponent>)> = {
  ...
  "flow_wallet-futures": () => import("@/views/flow/wallet-futures/index.vue"),
  "flow_wallet-loan": () => import("@/views/flow/wallet-loan/index.vue"),
  "flow_wallet-spot": () => import("@/views/flow/wallet-spot/index.vue"),
  "flow_wallet-stock": () => import("@/views/flow/wallet-stock/index.vue"),
